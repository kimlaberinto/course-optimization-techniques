...
calories = [158; 132; 128; 25; 49; 64; 11; 158; 62; 61; 104*2]
...
# Following asserts fail due to rounding/floating point accuracy
...
let
    ...
    pretty_table(table_data, header, title = "Nutritional Values of Food (double cal muffins)") #Show Table of Nutritional Constants
end
