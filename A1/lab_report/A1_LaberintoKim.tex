...
\begin{document}
    ...
    \begin{figure}[t]
        \centering
        \includesvg[width=\linewidth]{AllLines.svg}
        \caption{Caption}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{LineA_initialbracketing.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{LineB_GoldenComparison.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{LineB_initialbracketing.svg}
        \caption{Caption}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{LineC_initialbracketing.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q2_HookeJeeves_visualized.svg}
        \caption{Caption}
    \end{figure}
    
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q2_loss_vs_steps.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q2_stepsvisualized.svg}
        \caption{Caption}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_Autodiff_Comparison_LossVsSteps.svg}
        \caption{Caption}
    \end{figure}
    
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_BestFits_1.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_BestFits_2.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_BestFits_3.svg}
        \caption{Caption}
    \end{figure}
    
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_LossVsSteps_1.svg}
        \caption{Caption}
    \end{figure}

    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_LossVsSteps_2.svg}
        \caption{Caption}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includesvg[width=\linewidth]{Q3_LossVsSteps_3.svg}
        \caption{Caption}
    \end{figure}
